...
export default function AdvisorTeam() {
  ...
  return (
    <>
      <Head>
        <title>Advisor Team - Darren AI Financial Advisor</title>
      </Head>
      <Layout>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
              {agents.map((agent) => (
                <div
                  key={agent.name}
                  className={`bg-white rounded-lg shadow-lg p-6 relative overflow-hidden transition-all duration-300 ${isAgentActive(agent.name) ? 'ring-4 ring-ai-accent ring-opacity-50' : ''
                    }`}
                >
            ...
            <div className="bg-white rounded-lg shadow px-8 py-6">
              <div className="flex items-center justify-between mb-6">
                ...
                <button
                  ...
                  className={`px-8 py-4 rounded-lg font-semibold text-white transition-all ${isAnalyzing
